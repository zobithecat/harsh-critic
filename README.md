...
**Windows (PowerShell):**
\`\`\`powershell
irm https://raw.githubusercontent.com/zobithecat/harsh-critic/master/setup.sh | % { \$_ -replace "\r", "" } | bash
\`\`\`
...
**Windows (PowerShell):**
\`\`\`powershell
irm https://raw.githubusercontent.com/zobithecat/harsh-critic/master/README.md -OutFile README_HARSH.md
\`\`\`
